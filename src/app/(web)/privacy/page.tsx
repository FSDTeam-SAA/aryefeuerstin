        ...
        <div className="space-y-8 text-gray-800">
          ...
          <section>
            ...
            <ul className="ml-6 space-y-2 list-disc text-sm sm:text-base text-[#424242]">
              ...
              <li>
                <strong>Mobile Phone Number &amp; SMS Data:</strong> If you opt in to receive text messages from us, we
                collect your mobile phone number, opt-in timestamp, and records of your SMS consent. We also maintain
                logs of messages sent and delivery status for compliance purposes.
              </li>
              <li>
                <strong>Wellness &amp; Lifestyle Data:</strong> Optional information you choose to share through
                assessments, wellness tools, AI-sign quizzes, or coaching sessions.
          ...
          <section>
            ...
            <ul className="ml-6 space-y-1 list-disc text-sm sm:text-base text-[#424242]">
              ...
              <li>Send newsletters, updates, and marketing materials (with your consent)</li>
              <li>
                Send SMS/text messages related to appointments, coaching updates, promotions, or account notifications
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed text-sm sm:text-base text-[#424242]">
              If you opt in to receive SMS messages from Wellness Made Clear, the following applies:
            </p>
            <ul className="ml-6 space-y-2 list-disc text-sm sm:text-base text-[#424242]">
              <li>
                <strong>Consent:</strong> By providing your mobile number and opting in, you agree to receive text
                messages from Wellness Made Clear. Consent is not a condition of any purchase.
              </li>
              <li>
                <strong>Message Types:</strong> Messages may include appointment reminders, coaching updates, wellness
                tips, promotional offers, and account-related notifications.
              </li>
              <li>
                <strong>Message Frequency:</strong> Message frequency may vary depending on your interactions with us.
              </li>
              <li>
                <strong>Rates:</strong> Message and data rates may apply based on your mobile carrier plan.
              </li>
              <li>
                <strong>Opt-Out:</strong> You can opt out at any time by replying <strong>STOP</strong> to any message.
                After opting out, you will receive a confirmation message and no further SMS communications from us.
              </li>
              <li>
                <strong>Help:</strong> Reply <strong>HELP</strong> to any message or email us at{" "}
                <a href="mailto:ezreturn123@gmail.com" className="text-blue-600 hover:underline">
                  ezreturn123@gmail.com
                </a>{" "}
                for assistance.
              ...
              <li>
                <strong>Privacy:</strong> Your mobile information and SMS opt-in data will never be sold, rented, or
          ...
          {/* 5. Data Security */}
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#131313] sm:text-2xl">5. Data Security</h2>
            <p className="leading-relaxed text-sm sm:text-base text-[#424242]">
              We take reasonable administrative, technical, and physical measures to protect your personal information.
              This includes encrypted data transmission, secure hosting, and strict access controls. However, no method
              of transmission or storage is 100% secure. By using our platform, you acknowledge that some risk of data
          ...
          {/* 7. Cookies & Tracking */}
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#131313] sm:text-2xl">7. Cookies &amp; Tracking</h2>
            <p className="leading-relaxed text-sm sm:text-base text-[#424242]">
              We use cookies, pixels, and similar technologies to analyze website traffic, enhance your experience, and
              personalize content. You can adjust cookie preferences through your browser settings at any time.
            </p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#131313] sm:text-2xl">8. Children&apos;s Privacy</h2>
            <p className="leading-relaxed text-sm sm:text-base text-[#424242]">
              Our services are intended for adults 18 years and older. We do not knowingly collect data from individuals
              under 18. If such data is discovered, it will be promptly deleted.
            </p>
          ...
          {/* 9. Your Rights */}
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#131313] sm:text-2xl">9. Your Rights</h2>
            <p className="mb-3 leading-relaxed text-sm sm:text-base">You may at any time:</p>
            <ul className="ml-6 space-y-1 list-disc text-sm sm:text-base text-[#424242]">
              <li>Request access to your personal data</li>
              <li>Correct or update your information</li>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#131313] sm:text-2xl">10. Changes to This Policy</h2>
            <p className="leading-relaxed text-sm sm:text-base text-[#424242]">
              This policy may be updated as our business evolves or as required by law. Updates will be posted here with
              the effective date listed above.
            </p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-[#131313] sm:text-2xl">11. Contact Information</h2>
            <p className="mb-3 leading-relaxed text-sm sm:text-base">Wellness Made Clear LLC</p>
            <div className="space-y-1 text-sm sm:text-base">
              <p className="leading-relaxed">
                📧 Email:{" "}
