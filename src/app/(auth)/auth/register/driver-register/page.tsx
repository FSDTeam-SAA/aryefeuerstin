                ...
                <div className="w-full max-w-3xl p-8 rounded-xl  space-y-6">
                    ...
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <Input id="firstName" className="bg-[#FFFAEF] py-4 mt-2" placeholder="Enter your first name" />
                        </div>

                        {/* Last Name */}
                        <div>
                            <Label htmlFor="lastName">Last Name *</Label>
                            <Input id="lastName" className="bg-[#FFFAEF] py-4 mt-2" placeholder="Enter your last name" />
                        </div>

                        {/* Email */}
                        <div>
                            <Label htmlFor="email">Email *</Label>
                            <Input id="email" type="email" className="bg-[#FFFAEF] py-4 mt-2" placeholder="Enter your email" />
                        </div>
                        ...
                        <Button
                            type="submit"
                            className="w-full h-11 bg-[#F4803C] hover:bg-[#F4803C]"
                        >
                            Create Account
                        </Button>
